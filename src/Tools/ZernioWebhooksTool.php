...
#[ToolParameter(name: 'events', type: 'string[]', description: 'Event names to subscribe to (e.g. "post.published", "account.disconnected", "lead.submitted"). At least one required on create.', required: ['create_webhook'], items: ['type' => 'string'])]
