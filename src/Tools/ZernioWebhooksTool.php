...
#[ToolParameter(name: 'webhook_id', type: 'string', description: 'Webhook ID (the `_id` from list_webhooks). Required for update_webhook and delete_webhook.', required: false)]
#[ToolParameter(name: 'name', type: 'string', description: 'Webhook name (1-50 chars).', required: false)]
#[ToolParameter(name: 'url', type: 'string', description: 'HTTPS URL that will receive the webhook events.', required: false)]
...
#[ToolParameter(name: 'events', type: 'string[]', description: 'Event names to subscribe to (e.g. "post.published", "account.disconnected", "lead.submitted"). At least one required on create.', required: false, items: ['type' => 'string'])]
