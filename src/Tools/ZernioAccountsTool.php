...
#[ToolParameter(name: 'profile_id', type: 'string', description: 'Profile ID — required for update_profile/delete_profile/move_account; optional filter for list_accounts/account_health.', required: ['update_profile', 'delete_profile', 'move_account'])]
...
#[ToolParameter(name: 'account_id', type: 'string', description: 'Account ID — required for update_account/move_account/disconnect_account/get_account_health.', required: ['update_account', 'move_account', 'disconnect_account', 'get_account_health'])]
#[ToolParameter(name: 'name', type: 'string', description: 'Profile name. Required for create_profile; optional for update_profile.', required: ['create_profile'])]
