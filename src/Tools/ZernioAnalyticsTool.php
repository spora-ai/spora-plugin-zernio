...
#[ToolParameter(name: 'account_id', type: 'string', description: 'Account ID for post_analytics (batch lookup), best_time_to_post, or content_decay.', required: ['post_analytics', 'best_time_to_post', 'content_decay'])]
...
#[ToolParameter(name: 'platform', type: 'string', description: 'Platform name (e.g. "twitter", "instagram") — required for post_analytics/best_time_to_post, optional filter for account_health.', required: ['post_analytics', 'best_time_to_post'])]
#[ToolParameter(name: 'profile_id', type: 'string', description: 'Profile ID — required for daily_metrics/posting_frequency, optional filter for account_health/follower_analytics.', required: ['daily_metrics', 'posting_frequency'])]
